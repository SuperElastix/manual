...
The continued development brings us today (\today) to version 5.3.0.
...
\item Download and compile the ITK version 5.4.1 or higher: \url{www.itk.org}.
...
\item \elastix\ (\url{https://elastix.dev/}, [1]) is an open-source
    ...
    \url{https://github.com/SuperElastix/elastix/releases/download/5.3.0/elastix-5.3.0-manual.pdf}.
